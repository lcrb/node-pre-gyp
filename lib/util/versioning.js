...
module.exports.evaluate = function(package_json,options) {
    ...
    var electron_runtime = process.versions['electron'] ? 'electron' : null;
    var node_webkit_runtime = process.versions['node_webkit'] ? 'node_webkit' : null;
    var runtime = options.runtime || electron_runtime || node_webkit_runtime;
    var opts = {
